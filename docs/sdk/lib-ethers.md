...
[Home](./index.md) &gt; [@fluidity/lib-ethers](./lib-ethers.md)
...
|  [BorrowingOperationOptionalParams](./lib-ethers.borrowingoperationoptionalparams.md) | Optional parameters of a transaction that borrows ONEU. |
