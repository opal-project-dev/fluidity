...
[Home](./index.md) &gt; [@fluidity/lib-base](./lib-base.md) &gt; [TransactableLiquity](./lib-base.transactableliquity.md) &gt; [adjustTrove](./lib-base.transactableliquity.adjusttrove.md)
...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable [borrowing rate](./lib-base.fees.borrowingrate.md) if <code>params</code> includes <code>borrowONEU</code>. |
...
The transaction will fail if the Trove's debt would fall below [ONEU\_MINIMUM\_DEBT](./lib-base.oneu_minimum_debt.md)<!-- -->.
