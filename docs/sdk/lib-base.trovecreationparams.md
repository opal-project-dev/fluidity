...
[Home](./index.md) &gt; [@fluidity/lib-base](./lib-base.md) &gt; [TroveCreationParams](./lib-base.trovecreationparams.md)
...
```typescript
export declare type TroveCreationParams<T = unknown> = _CollateralDeposit<T> & _NoCollateralWithdrawal & _ONEUBorrowing<T> & _NoONEURepayment;
```
...
<tr> <td> borrowONEU </td> <td> T </td> <td> The amount of ONEU that's borrowed. </td> </tr>
