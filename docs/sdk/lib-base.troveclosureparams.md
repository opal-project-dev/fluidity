...
[Home](./index.md) &gt; [@fluidity/lib-base](./lib-base.md) &gt; [TroveClosureParams](./lib-base.troveclosureparams.md)
...
```typescript
export declare type TroveClosureParams<T> = _CollateralWithdrawal<T> & _NoCollateralDeposit & Partial<_ONEURepayment<T>> & _NoONEUBorrowing;
```
