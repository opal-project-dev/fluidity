...
[Home](./index.md) &gt; [@fluidity/lib-ethers](./lib-ethers.md) &gt; [EthersLiquityConnection](./lib-ethers.ethersliquityconnection.md)
...
|  [liquidityMiningOPLRewardRate](./lib-ethers.ethersliquityconnection.liquidityminingoplrewardrate.md) | [Decimal](./lib-base.decimal.md) | Amount of OPL collectively rewarded to stakers of the liquidity mining pool per second. |
...
|  [totalStabilityPoolOPLReward](./lib-ethers.ethersliquityconnection.totalstabilitypooloplreward.md) | [Decimal](./lib-base.decimal.md) | Total amount of OPL allocated for rewarding stability depositors. |
