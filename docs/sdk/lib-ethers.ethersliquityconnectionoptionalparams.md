...
[Home](./index.md) &gt; [@fluidity/lib-ethers](./lib-ethers.md) &gt; [EthersLiquityConnectionOptionalParams](./lib-ethers.ethersliquityconnectionoptionalparams.md)
...
|  --- | --- | --- | --- |
|  [frontendTag?](./lib-ethers.ethersliquityconnectionoptionalparams.frontendtag.md) |  | string | _(Optional)_ Address that will receive OPL rewards from newly created Stability Deposits by default. |
|  [userAddress?](./lib-ethers.ethersliquityconnectionoptionalparams.useraddress.md) |  | string | _(Optional)_ Address whose Trove, Stability Deposit, OPL Stake and balances will be read by default. |
