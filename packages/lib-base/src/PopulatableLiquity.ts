 ...
 *
 * @remarks
 * Implemented by {@link @fluidity/lib-ethers#PopulatedEthersLiquityTransaction}.
 *
 * @public
 */
...
> {
   ...
   *
   * @returns An object that implements {@link @fluidity/lib-base#SentLiquityTransaction}.
   */
  send(): Promise<T>;
}
...
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
   ...
   *                            {@link @fluidity/lib-base#Fees.redemptionRate | redemption rate} to
 ...
 *
 * Implemented by {@link @fluidity/lib-ethers#PopulatableEthersLiquity}.
 *
 * @public
 */
