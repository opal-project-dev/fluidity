 ...
 *
 * @remarks
 * Implemented by {@link @fluidity/lib-ethers#SentEthersLiquityTransaction}.
 *
 * @public
 */
export interface SentLiquityTransaction<S = unknown, T extends LiquityReceipt = LiquityReceipt> {
   ...
   *
   * @remarks
   * Unlike {@link @fluidity/lib-base#SentLiquityTransaction.waitForReceipt | waitForReceipt()},
   ...
   *
   * @returns Either a {@link @fluidity/lib-base#FailedReceipt} or a
   *          {@link @fluidity/lib-base#SuccessfulReceipt}.
   */
 ...
 *
 * Implemented by {@link @fluidity/lib-ethers#SendableEthersLiquity}.
 *
 * @public
 */
