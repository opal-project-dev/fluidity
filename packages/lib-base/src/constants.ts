 ...
 * @public
 */
export const ONEU_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link ONEU_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const ONEU_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const ONEU_MINIMUM_DEBT = ONEU_LIQUIDATION_RESERVE.add(ONEU_MINIMUM_NET_DEBT);
