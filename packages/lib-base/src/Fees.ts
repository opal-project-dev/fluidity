...
export class Fees {
   ...
   *
   * @param redeemedFractionOfSupply - The amount of ONEU being redeemed divided by the total supply.
   ...
   * precise, it depends on the fraction of the redeemed amount compared to the total ONEU supply,
   * which must be passed as a parameter.
   *
   * To calculate the redemption fee in ONEU, multiply the redeemed ONEU amount with the redemption
   * rate.
   *
   * @example
   * ```typescript
