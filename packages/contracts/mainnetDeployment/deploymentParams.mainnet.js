const externalAddrs = {
  CHAINLINK_AUTUSD_PROXY: "<CHAINLINK_AUTUSD_PROXY>"
};

const opalAddrs = {
  GENERAL_SAFE: "<GENERAL_SAFE>", // to be passed to OPLToken as the bounties/hackathons address
  OPL_SAFE: "<OPL_SAFE>", // to be passed to OPLToken as the OPL multisig address
  DEPLOYER: "<DEPLOYER>" // Mainnet REAL deployment address
};
