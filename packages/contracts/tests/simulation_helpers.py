...
print(" - AUT period 1 -")
print(f"Min AUT price: {min(price_ether[1:period1])}")
print(f"Max AUT price: {max(price_ether[1:period1])}")
for i in range(period1, period2):
    random.seed(2019375+10000*i)
    shock_ether = random.normalvariate(0, sd_ether)
    price_ether.append(price_ether[i-1] * (1 + shock_ether) * (1 + drift_ether2))
print(" - AUT period 2 -")
print(f"Min AUT price: {min(price_ether[period1:period2])}")
print(f"Max AUT price: {max(price_ether[period1:period2])}")
for i in range(period2, period3):
    random.seed(2019375+10000*i)
    shock_ether = random.normalvariate(0, sd_ether)
    price_ether.append(price_ether[i-1] * (1 + shock_ether) * (1 + drift_ether3))
print(" - AUT period 3 -")
print(f"Min AUT price: {min(price_ether[period2:period3])}")
print(f"Max AUT price: {max(price_ether[period2:period3])}")
for i in range(period3, period4):
    random.seed(2019375+10000*i)
    shock_ether = random.normalvariate(0, sd_ether)
    price_ether.append(price_ether[i-1] * (1 + shock_ether) * (1 + drift_ether4))
print(" - AUT period 4 -")
print(f"Min AUT price: {min(price_ether[period3:period4])}")
print(f"Max AUT price: {max(price_ether[period3:period4])}")
