...
# return the innate component of market demand for holding OPL tokens.  Could be a function of:
...
def linear_decreasing_AUT_price(last_price, gradient):
    return last_price - gradient

def quadratic_AUT_price(scale, i):
    return scale*(i**2)
...
for i in range(1, 100):
    ...
    # AUT_price = oscillating_AUT_price(500, 10, i)
    # AUT_price = quadratic_AUT_price(10, i)
    # AUT_price = linear_increasing_AUT_price(last_AUT_price, 100)
    # AUT_price = linear_decreasing_AUT_price(last_AUT_price, 1)
