...
contract("Gas cost tests", async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 aut, withdraw 100 LUSD
  ...
  it("", async () => {
    ...
    //60 accts open Trove with 1 aut and withdraw 100 LUSD
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 15 aut, withdraw 100 LUSD
    await th.openTrove_allAccounts(
      accounts.slice(101, 111),
      contracts,
      dec(15, "ether"),
    ...
    //65 accts open Trove with 1 aut and withdraw 100 LUSD
  ...
  it("", async () => {
    ...
    //50 accts open Trove with 1 aut and withdraw 100 LUSD
    const _50_Defaulters = accounts.slice(1, 51);
    await th.openTrove_allAccounts(_50_Defaulters, contracts, dec(100, "ether"), dec(9500, 18));
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 aut and withdraws 2000 LUSD
    await borrowerOperations.openTrove(_100pct, dec(2000, 18), accounts[500], ZERO_ADDRESS, {
      from: accounts[500],
      value: dec(20, "ether")
    });
