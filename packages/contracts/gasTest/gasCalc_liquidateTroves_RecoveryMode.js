...
contract("Gas cost tests", async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 aut, withdraw 900 ONEU
    ...
    //1 accts open Trove with 1 aut and withdraw 100 ONEU
    ...
    // Account 500 opens with 1 aut and withdraws 100 ONEU
    ...
    // Check initial troves with starting 10E/90ONEU are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 aut and withdraw 100 ONEU
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 aut and withdraw 100 ONEU
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 aut and withdraw 100 ONEU
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 aut and withdraw 100 ONEU
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 aut, withdraw 90 ONEU
    await th.openTrove_allAccounts(
      accounts.slice(101, 111),
      contracts,
      dec(10, "ether"),
    ...
    //20 accts open Trove with 1 aut and withdraw 100 ONEU
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 aut and withdraw 100 ONEU
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 aut and withdraw 100 ONEU
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion ONEU
    ...
    // Check SP has 9e28 ONEU
    const ONEUinSP = (await stabilityPool.getTotalONEUDeposits()).toString();
    assert.equal(ONEUinSP, dec(9, 28));

    //1 acct opens Trove with 1 aut and withdraw 100 ONEU
    const _1_Defaulter = accounts.slice(1, 2);
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, "ether"), dec(60, 18));
    ...
    // Check initial troves with starting 10E/90ONEU, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
    assert.isTrue(await sortedTroves.contains(whale));

    //Check ONEU in SP has decreased but is still > 0
    const ONEUinSP_After = await stabilityPool.getTotalONEUDeposits();
    assert.isTrue(ONEUinSP_After.lt(web3.utils.toBN(dec(9, 28))));
    assert.isTrue(ONEUinSP_After.gt(web3.utils.toBN("0")));
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 aut and withdraw 100 ONEU
    const _2_Defaulters = accounts.slice(1, 3);
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, "ether"), dec(60, 18));
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 aut and withdraw 100 ONEU
    const _45_Defaulters = accounts.slice(1, 46);
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, "ether"), dec(9500, 18));
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 aut and withdraws 110 ONEU
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 aut, withdraws ONEU
    ...
    // Account 500 opens with 1 aut and withdraws ONEU
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 aut and withdraws 180 ONEU
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS, {
      from: accounts[500],
      value: dec(100, "ether")
    });
