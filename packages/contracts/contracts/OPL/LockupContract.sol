...
* Within the first year from deployment, the deployer of the OPLToken (Liquity AG's address) may transfer OPL only to valid 
* LockupContracts, and no other addresses (this is enforced in OPLToken.sol's transfer() function).
* 
* The above two restrictions ensure that until one year after system deployment, OPL tokens originating from Liquity AG cannot 
...
contract LockupContract {
    ...
    event LockupContractEmptied(uint _OPLwithdrawal);
