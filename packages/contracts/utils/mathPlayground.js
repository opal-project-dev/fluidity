...
const ABDKOperations = async () => {
  ...
  // Example computaton: ONEU -> Ether price conversion

  // price = 200.12345678, stored as uint
  // convert 6123456700909.123456789123456789 ONEU to Ether
  // amount = 6123456700909.123456789123456789 ONEU / 200.12345678
  ...
  /* TODO: will L_AUT, L_ONEU overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
  ...
  /* 
    ...
    ABDK.divu is for: (uint / uint)  -> 64.64dec.  i.e. for liquidatedAUT / totalStakes 
