...
contract("TroveManager - Redistribution reward calculations", async accounts => {
  ...
  it("redistribution: A,B,C Open. Liq(C). B tops up coll. D Opens. Liq(D). Distributes correct rewards.", async () => {
    ...
    /* Bob rewards:
     L1: 1/2*0.995 AUT, 55 LUSD
     L2: (2.4975/3.995)*0.995 = 0.622 AUT , 110*(2.4975/3.995)= 68.77 LUSDDebt
    ...
    debt: 233.77 LUSDDebt
     ...
     Alice rewards:
    L1 1/2*0.995 AUT, 55 LUSD
    L2 (1.4975/3.995)*0.995 = 0.3730 AUT, 110*(1.4975/3.995) = 41.23 LUSDDebt
  ...
  it("redistribution: A,B,C Open. Liq(C). B withdraws coll. D Opens. Liq(D). Distributes correct rewards.", async () => {
    ...
    /* Bob rewards:
     L1: 0.4975 AUT, 55 LUSD
     L2: (0.9975/2.495)*0.995 = 0.3978 AUT , 110*(0.9975/2.495)= 43.98 LUSDDebt
    ...
    debt: (110 + 55 + 43.98 = 208.98 LUSDDebt 
     ...
     Alice rewards:
    L1 0.4975, 55 LUSD
    L2 (1.4975/2.495)*0.995 = 0.5972 AUT, 110*(1.4975/2.495) = 66.022 LUSDDebt
