...
contract("StabilityPool - Withdrawal of stability deposit - Reward calculations", async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawAUTGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and AUT Gain after one liquidation", async () => {
      ...
      const txA = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: alice
      });
      const txB = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: bob
      });
      const txC = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: carol
      });
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedONEUDeposit(alice)).toString(),
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedONEUDeposit(bob)).toString(),
          "6666666666666666666666"
        ),
        10000
      );
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedONEUDeposit(carol)).toString(),
          "6666666666666666666666"
        ),
        10000
      );
    ...
    it("withdrawAUTGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and AUT Gain after two identical liquidations", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove():  Depositors with equal initial deposit withdraw correct compounded deposit and AUT Gain after three identical liquidations", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(alice)).toString(), "0"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(bob)).toString(), "0"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(carol)).toString(), "0"),
        10000
      );
    ...
    it("withdrawAUTGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and AUT Gain after two liquidations of increasing ONEU", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and AUT Gain after three liquidations of increasing ONEU", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and AUT Gain after two identical liquidations", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and AUT Gain after three identical liquidations", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and AUT Gain after three varying liquidations", async () => {
    ...
    it("withdrawAUTGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 ONEU.  A, B, C, D withdraw correct ONEU deposit and AUT Gain", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      const txD = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: dennis
      });
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedONEUDeposit(dennis)).toString(),
          "5000000000000000000000"
        ),
        100000
      );
    ...
    it("withdrawAUTGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 ONEU.  A, B, C, D withdraw correct ONEU deposit and AUT Gain", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(dennis)).toString(), "0"),
        100000
      );
    ...
    it("withdrawAUTGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct ONEU deposit and AUT Gain", async () => {
      // Whale opens Trove with 1m AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(1000000, 18)),
    ...
    it("withdrawAUTGainToTrove(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 ONEU.  A, B, C, D withdraw correct ONEU deposit and AUT Gain", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct ONEU deposit and AUT Gain", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 ONEU. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct ONEU deposit and AUT Gain", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Pool-emptying liquidation increases epoch by one, resets scaleFactor to 0, and resets P to 1e18", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      const txE = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: erin
      });
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedONEUDeposit(erin)).toString(),
    ...
    it("withdrawAUTGainToTrove(): single deposit fully offset. After subsequent liquidations, depositor withdraws 0 deposit and *only* the AUT Gain from one liquidation", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      const txF = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: flyn
      });
      const txG = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: graham
      });
      const txH = await stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: harriet
      });
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(erin)).toString(), "0"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(flyn)).toString(), "0"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(graham)).toString(), "0"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(harriet)).toString(), "0"),
        100000
      );
    ...
    it("withdrawAUTGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and AUT Gain after one liquidation", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      // Expect Bob to retain 1% of initial deposit (100 ONEU) and all the liquidated AUT (60 ether)
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedONEUDeposit(bob)).toString(),
    ...
    // expect d(B) = d0(B)/100
    // expect correct AUT gain, i.e. all of the reward
    it("withdrawAUTGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and AUT Gain after one liquidation", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      /* Expect depositors to retain 1% of their initial deposit, and an AUT gain 
    ...
    it("withdrawAUTGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and AUT Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedONEUDeposit(bob)).toString(), dec(1, 17)),
        100000
      );
    ...
    // expect d(B) = d0(B) * 1e-5
    // expect B gets entire AUT gain from L2
    it("withdrawAUTGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and AUT Gain after one liquidation", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    */
    it("withdrawAUTGainToTrove(): Several deposits of 10000 ONEU span one scale factor change. Depositors withdraws correct compounded deposit and AUT Gain after one liquidation", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      assert.equal(await stabilityPool.getCompoundedONEUDeposit(alice), "0");
      assert.equal(await stabilityPool.getCompoundedONEUDeposit(alice), "0");
      assert.equal(await stabilityPool.getCompoundedONEUDeposit(alice), "0");
      // D should retain around 0.9999 ONEU, since his deposit of 9999.9 was reduced by a factor of 1e-5
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedONEUDeposit(dennis)).toString(),
          dec(99999, 12)
    ...
    it("withdrawAUTGainToTrove(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
    ...
    it("withdrawAUTGainToTrove(): Large liquidated coll/debt, deposits and AUT price", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      const bobONEUBalance = await stabilityPool.getCompoundedONEUDeposit(bob);
    ...
    it("withdrawAUTGainToTrove(): Small liquidated coll/debt, large deposits and AUT price", async () => {
      // Whale opens Trove with 100k AUT
      await borrowerOperations.openTrove(
        th._100pct,
        await getOpenTroveONEUAmount(dec(100000, 18)),
      ...
      const txAPromise = stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: alice
      });
      const txBPromise = stabilityPool.withdrawAUTGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: bob
      });
      ...
      await th.assertRevert(txAPromise, "StabilityPool: caller must have non-zero AUT Gain");
