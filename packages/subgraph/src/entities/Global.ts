...
export function updateTotalRedistributed(L_AUT: BigInt, L_ONEUDebt: BigInt): void {
  let global = getGlobal();

  global.rawTotalRedistributedCollateral = L_AUT;
  global.rawTotalRedistributedDebt = L_ONEUDebt;
  global.save();
}
