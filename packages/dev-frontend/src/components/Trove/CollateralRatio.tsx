...
export const CollateralRatio: React.FC<CollateralRatioProps> = ({ value, liqPrice, change }) => {
    ...
    return (
        <>
                        ...
                        <InfoIcon
                            tooltip={
                                <Card variant="tooltip" sx={{ width: "220px" }}>
                                    The ratio between the dollar value of the collateral and the debt (in OUSD) you are
            ...
            <StaticRow
                ...
                amount={liqPrice?.prettify(2) ?? "N/A"}
                color={liqPrice ? "black" : "muted"}
                unit="USD"
                infoIcon={
                    <InfoIcon
                        tooltip={
