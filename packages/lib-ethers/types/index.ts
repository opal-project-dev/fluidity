...
interface ActivePoolCalls {
  ...
  getAUT(_overrides?: CallOverrides): Promise<BigNumber>;
  getONEUDebt(_overrides?: CallOverrides): Promise<BigNumber>;
...
interface ActivePoolTransactions {
  decreaseONEUDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseONEUDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  sendAUT(_account: string, _amount: BigNumberish, _overrides?: Overrides): Promise<void>;
...
export interface ActivePool
  ...
  readonly filters: {
    AUTBalanceUpdated(_newBalance?: null): EventFilter;
    ActivePoolAUTBalanceUpdated(_AUT?: null): EventFilter;
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    ActivePoolONEUDebtUpdated(_ONEUDebt?: null): EventFilter;
    ...
    ONEUBalanceUpdated(_newBalance?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "AUTBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "ActivePoolAUTBalanceUpdated"): _TypedLogDescription<{ _AUT: BigNumber }>[];
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _newActivePoolAddress: string }>[];
  extractEvents(logs: Log[], name: "ActivePoolONEUDebtUpdated"): _TypedLogDescription<{ _ONEUDebt: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "ONEUBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
...
interface BorrowerOperationsCalls {
  ...
  NAME(_overrides?: CallOverrides): Promise<string>;
  ONEU_GAS_COMPENSATION(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  oneuToken(_overrides?: CallOverrides): Promise<string>;
  oplStaking(_overrides?: CallOverrides): Promise<string>;
  oplStakingAddress(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
...
interface BorrowerOperationsTransactions {
  ...
  adjustTrove(_maxFeePercentage: BigNumberish, _collWithdrawal: BigNumberish, _ONEUChange: BigNumberish, _isDebtIncrease: boolean, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  claimCollateral(_overrides?: Overrides): Promise<void>;
  closeTrove(_overrides?: Overrides): Promise<void>;
  moveAUTGainToTrove(_borrower: string, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  openTrove(_maxFeePercentage: BigNumberish, _ONEUAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  repayONEU(_ONEUAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_troveManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _sortedTrovesAddress: string, _oneuTokenAddress: string, _oplStakingAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawColl(_collWithdrawal: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  withdrawONEU(_maxFeePercentage: BigNumberish, _ONEUAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
}
...
export interface BorrowerOperations
  ...
  readonly filters: {
    ...
    ONEUBorrowingFeePaid(_borrower?: string | null, _ONEUFee?: null): EventFilter;
    ONEUTokenAddressChanged(_oneuTokenAddress?: null): EventFilter;
    OPLStakingAddressChanged(_oplStakingAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "ONEUBorrowingFeePaid"): _TypedLogDescription<{ _borrower: string; _ONEUFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "ONEUTokenAddressChanged"): _TypedLogDescription<{ _oneuTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OPLStakingAddressChanged"): _TypedLogDescription<{ _oplStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
...
interface CommunityIssuanceCalls {
  ...
  NAME(_overrides?: CallOverrides): Promise<string>;
  OPLSupplyCap(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  oplToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  stabilityPoolAddress(_overrides?: CallOverrides): Promise<string>;
  totalOPLIssued(_overrides?: CallOverrides): Promise<BigNumber>;
}

interface CommunityIssuanceTransactions {
  issueOPL(_overrides?: Overrides): Promise<BigNumber>;
  sendOPL(_account: string, _OPLamount: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_oplTokenAddress: string, _stabilityPoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface CommunityIssuance
  extends _TypedLiquityContract<CommunityIssuanceCalls, CommunityIssuanceTransactions> {
  readonly filters: {
    OPLTokenAddressSet(_oplTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StabilityPoolAddressSet(_stabilityPoolAddress?: null): EventFilter;
    TotalOPLIssuedUpdated(_totalOPLIssued?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "OPLTokenAddressSet"): _TypedLogDescription<{ _oplTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressSet"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "TotalOPLIssuedUpdated"): _TypedLogDescription<{ _totalOPLIssued: BigNumber }>[];
}
...
interface DefaultPoolTransactions {
  decreaseONEUDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseONEUDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  sendAUTToActivePool(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
...
export interface DefaultPool
  ...
  readonly filters: {
    AUTBalanceUpdated(_newBalance?: null): EventFilter;
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    DefaultPoolAUTBalanceUpdated(_AUT?: null): EventFilter;
    DefaultPoolAddressChanged(_newDefaultPoolAddress?: null): EventFilter;
    DefaultPoolONEUDebtUpdated(_ONEUDebt?: null): EventFilter;
    EtherSent(_to?: null, _amount?: null): EventFilter;
    ONEUBalanceUpdated(_newBalance?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StabilityPoolAddressChanged(_newStabilityPoolAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "AUTBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _newActivePoolAddress: string }>[];
  extractEvents(logs: Log[], name: "DefaultPoolAUTBalanceUpdated"): _TypedLogDescription<{ _AUT: BigNumber }>[];
  extractEvents(logs: Log[], name: "DefaultPoolAddressChanged"): _TypedLogDescription<{ _newDefaultPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "DefaultPoolONEUDebtUpdated"): _TypedLogDescription<{ _ONEUDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "EtherSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "ONEUBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _newStabilityPoolAddress: string }>[];
...
interface HintHelpersCalls {
  ...
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getRedemptionHints(_ONEUamount: BigNumberish, _price: BigNumberish, _maxIterations: BigNumberish, _overrides?: CallOverrides): Promise<{ firstRedemptionHint: string; partialRedemptionHintNICR: BigNumber; truncatedONEUamount: BigNumber }>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface LockupContractFactoryCalls {
  ...
  oplTokenAddress(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
}
...
interface LockupContractFactoryTransactions {
  ...
  setOPLTokenAddress(_oplTokenAddress: string, _overrides?: Overrides): Promise<void>;
}
...
interface ONEUTokenTransactions {
...
export interface ONEUToken
  extends _TypedLiquityContract<ONEUTokenCalls, ONEUTokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
    ONEUTokenBalanceUpdated(_user?: null, _amount?: null): EventFilter;
    StabilityPoolAddressChanged(_newStabilityPoolAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressChanged"): _TypedLogDescription<{ _newBorrowerOperationsAddress: string }>[];
  extractEvents(logs: Log[], name: "ONEUTokenBalanceUpdated"): _TypedLogDescription<{ _user: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _newStabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{ _troveManagerAddress: string }>[];
}

interface OPLStakingCalls {
  DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
  F_AUT(_overrides?: CallOverrides): Promise<BigNumber>;
  F_ONEU(_overrides?: CallOverrides): Promise<BigNumber>;
  NAME(_overrides?: CallOverrides): Promise<string>;
  activePoolAddress(_overrides?: CallOverrides): Promise<string>;
  borrowerOperationsAddress(_overrides?: CallOverrides): Promise<string>;
  getPendingAUTGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingONEUGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  oneuToken(_overrides?: CallOverrides): Promise<string>;
  oplToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  snapshots(arg0: string, _overrides?: CallOverrides): Promise<{ F_AUT_Snapshot: BigNumber; F_ONEU_Snapshot: BigNumber }>;
  stakes(arg0: string, _overrides?: CallOverrides): Promise<BigNumber>;
  totalOPLStaked(_overrides?: CallOverrides): Promise<BigNumber>;
  troveManagerAddress(_overrides?: CallOverrides): Promise<string>;
}

interface OPLStakingTransactions {
  increaseF_AUT(_AUTFee: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseF_ONEU(_ONEUFee: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_oplTokenAddress: string, _oneuTokenAddress: string, _troveManagerAddress: string, _borrowerOperationsAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
  stake(_OPLamount: BigNumberish, _overrides?: Overrides): Promise<void>;
  unstake(_OPLamount: BigNumberish, _overrides?: Overrides): Promise<void>;
}

export interface OPLStaking
  extends _TypedLiquityContract<OPLStakingCalls, OPLStakingTransactions> {
  readonly filters: {
    ...
    F_AUTUpdated(_F_AUT?: null): EventFilter;
    F_ONEUUpdated(_F_ONEU?: null): EventFilter;
    ONEUTokenAddressSet(_oneuTokenAddress?: null): EventFilter;
    OPLTokenAddressSet(_oplTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StakeChanged(staker?: string | null, newStake?: null): EventFilter;
    StakerSnapshotsUpdated(_staker?: null, _F_AUT?: null, _F_ONEU?: null): EventFilter;
    StakingGainsWithdrawn(staker?: string | null, ONEUGain?: null, AUTGain?: null): EventFilter;
    TotalOPLStakedUpdated(_totalOPLStaked?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "F_AUTUpdated"): _TypedLogDescription<{ _F_AUT: BigNumber }>[];
  extractEvents(logs: Log[], name: "F_ONEUUpdated"): _TypedLogDescription<{ _F_ONEU: BigNumber }>[];
  extractEvents(logs: Log[], name: "ONEUTokenAddressSet"): _TypedLogDescription<{ _oneuTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OPLTokenAddressSet"): _TypedLogDescription<{ _oplTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StakeChanged"): _TypedLogDescription<{ staker: string; newStake: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakerSnapshotsUpdated"): _TypedLogDescription<{ _staker: string; _F_AUT: BigNumber; _F_ONEU: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakingGainsWithdrawn"): _TypedLogDescription<{ staker: string; ONEUGain: BigNumber; AUTGain: BigNumber }>[];
  extractEvents(logs: Log[], name: "TotalOPLStakedUpdated"): _TypedLogDescription<{ _totalOPLStaked: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressSet"): _TypedLogDescription<{ _troveManager: string }>[];
}

interface OPLTokenCalls {
...
interface OPLTokenTransactions {
  approve(spender: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  decreaseAllowance(spender: string, subtractedValue: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  increaseAllowance(spender: string, addedValue: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  permit(owner: string, spender: string, amount: BigNumberish, deadline: BigNumberish, v: BigNumberish, r: BytesLike, s: BytesLike, _overrides?: Overrides): Promise<void>;
  sendToOPLStaking(_sender: string, _amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  transfer(recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  transferFrom(sender: string, recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
}

export interface OPLToken
  extends _TypedLiquityContract<OPLTokenCalls, OPLTokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    ...
    OPLStakingAddressSet(_oplStakingAddress?: null): EventFilter;
    Transfer(from?: string | null, to?: string | null, value?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "Approval"): _TypedLogDescription<{ owner: string; spender: string; value: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "OPLStakingAddressSet"): _TypedLogDescription<{ _oplStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; value: BigNumber }>[];
}

interface MultiTroveGetterCalls {
  getMultipleSortedTroves(_startIdx: BigNumberish, _count: BigNumberish, _overrides?: CallOverrides): Promise<{ owner: string; debt: BigNumber; coll: BigNumber; stake: BigNumber; snapshotAUT: BigNumber; snapshotONEUDebt: BigNumber }[]>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
  troveManager(_overrides?: CallOverrides): Promise<string>;
}
...
interface StabilityPoolCalls {
  ...
  getCompoundedONEUDeposit(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorAUTGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorOPLGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getFrontEndOPLGain(_frontEnd: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getTotalONEUDeposits(_overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  lastAUTError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  lastONEULossError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  lastOPLError(_overrides?: CallOverrides): Promise<BigNumber>;
  oneuToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface StabilityPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _troveManagerAddress: string, _activePoolAddress: string, _oneuTokenAddress: string, _sortedTrovesAddress: string, _priceFeedAddress: string, _communityIssuanceAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawAUTGainToTrove(_upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
...
export interface StabilityPool
  ...
  readonly filters: {
    AUTGainWithdrawn(_depositor?: string | null, _AUT?: null, _ONEULoss?: null): EventFilter;
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
    ...
    ONEUTokenAddressChanged(_newONEUTokenAddress?: null): EventFilter;
    OPLPaidToDepositor(_depositor?: string | null, _OPL?: null): EventFilter;
    OPLPaidToFrontEnd(_frontEnd?: string | null, _OPL?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    ...
    StabilityPoolAUTBalanceUpdated(_newBalance?: null): EventFilter;
    StabilityPoolONEUBalanceUpdated(_newBalance?: null): EventFilter;
    TroveManagerAddressChanged(_newTroveManagerAddress?: null): EventFilter;
    UserDepositChanged(_depositor?: string | null, _newDeposit?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "AUTGainWithdrawn"): _TypedLogDescription<{ _depositor: string; _AUT: BigNumber; _ONEULoss: BigNumber }>[];
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _newActivePoolAddress: string }>[];
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressChanged"): _TypedLogDescription<{ _newBorrowerOperationsAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "ONEUTokenAddressChanged"): _TypedLogDescription<{ _newONEUTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OPLPaidToDepositor"): _TypedLogDescription<{ _depositor: string; _OPL: BigNumber }>[];
  extractEvents(logs: Log[], name: "OPLPaidToFrontEnd"): _TypedLogDescription<{ _frontEnd: string; _OPL: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  ...
  extractEvents(logs: Log[], name: "StabilityPoolAUTBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "StabilityPoolONEUBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{ _newTroveManagerAddress: string }>[];
...
interface TroveManagerCalls {
  ...
  CCR(_overrides?: CallOverrides): Promise<BigNumber>;
  DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
  L_AUT(_overrides?: CallOverrides): Promise<BigNumber>;
  L_ONEUDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  defaultPool(_overrides?: CallOverrides): Promise<string>;
  getBorrowingFee(_ONEUDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  getBorrowingFeeWithDecay(_ONEUDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getEntireDebtAndColl(_borrower: string, _overrides?: CallOverrides): Promise<{ debt: BigNumber; coll: BigNumber; pendingONEUDebtReward: BigNumber; pendingAUTReward: BigNumber }>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getNominalICR(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingAUTReward(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingONEUDebtReward(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getRedemptionFeeWithDecay(_AUTDrawn: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  lastAUTError_Redistribution(_overrides?: CallOverrides): Promise<BigNumber>;
  lastFeeOperationTime(_overrides?: CallOverrides): Promise<BigNumber>;
  lastONEUDebtError_Redistribution(_overrides?: CallOverrides): Promise<BigNumber>;
  oneuToken(_overrides?: CallOverrides): Promise<string>;
  oplStaking(_overrides?: CallOverrides): Promise<string>;
  oplToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  rewardSnapshots(arg0: string, _overrides?: CallOverrides): Promise<{ AUT: BigNumber; ONEUDebt: BigNumber }>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface TroveManagerTransactions {
  ...
  redeemCollateral(_ONEUamount: BigNumberish, _firstRedemptionHint: string, _upperPartialRedemptionHint: string, _lowerPartialRedemptionHint: string, _partialRedemptionHintNICR: BigNumberish, _maxIterations: BigNumberish, _maxFeePercentage: BigNumberish, _overrides?: Overrides): Promise<void>;
  removeStake(_borrower: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _oneuTokenAddress: string, _sortedTrovesAddress: string, _oplTokenAddress: string, _oplStakingAddress: string, _overrides?: Overrides): Promise<void>;
...
export interface TroveManager
  ...
  readonly filters: {
    ...
    DefaultPoolAddressChanged(_defaultPoolAddress?: null): EventFilter;
    GasPoolAddressChanged(_gasPoolAddress?: null): EventFilter;
    LTermsUpdated(_L_AUT?: null, _L_ONEUDebt?: null): EventFilter;
    LastFeeOpTimeUpdated(_lastFeeOpTime?: null): EventFilter;
    Liquidation(_liquidatedDebt?: null, _liquidatedColl?: null, _collGasCompensation?: null, _ONEUGasCompensation?: null): EventFilter;
    ONEUTokenAddressChanged(_newONEUTokenAddress?: null): EventFilter;
    OPLStakingAddressChanged(_oplStakingAddress?: null): EventFilter;
    OPLTokenAddressChanged(_oplTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    Redemption(_attemptedONEUAmount?: null, _actualONEUAmount?: null, _AUTSent?: null, _AUTFee?: null): EventFilter;
    SortedTrovesAddressChanged(_sortedTrovesAddress?: null): EventFilter;
    StabilityPoolAddressChanged(_stabilityPoolAddress?: null): EventFilter;
    ...
    TroveSnapshotsUpdated(_L_AUT?: null, _L_ONEUDebt?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "DefaultPoolAddressChanged"): _TypedLogDescription<{ _defaultPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "GasPoolAddressChanged"): _TypedLogDescription<{ _gasPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "LTermsUpdated"): _TypedLogDescription<{ _L_AUT: BigNumber; _L_ONEUDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "LastFeeOpTimeUpdated"): _TypedLogDescription<{ _lastFeeOpTime: BigNumber }>[];
  extractEvents(logs: Log[], name: "Liquidation"): _TypedLogDescription<{ _liquidatedDebt: BigNumber; _liquidatedColl: BigNumber; _collGasCompensation: BigNumber; _ONEUGasCompensation: BigNumber }>[];
  extractEvents(logs: Log[], name: "ONEUTokenAddressChanged"): _TypedLogDescription<{ _newONEUTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OPLStakingAddressChanged"): _TypedLogDescription<{ _oplStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "OPLTokenAddressChanged"): _TypedLogDescription<{ _oplTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "Redemption"): _TypedLogDescription<{ _attemptedONEUAmount: BigNumber; _actualONEUAmount: BigNumber; _AUTSent: BigNumber; _AUTFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "SortedTrovesAddressChanged"): _TypedLogDescription<{ _sortedTrovesAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "TroveSnapshotsUpdated"): _TypedLogDescription<{ _L_AUT: BigNumber; _L_ONEUDebt: BigNumber }>[];
