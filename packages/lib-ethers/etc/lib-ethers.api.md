## API Report File for "@fluidity/lib-ethers"
...
import { CollateralGainTransferDetails } from '@fluidity/lib-base';
import { Decimal } from '@fluidity/lib-base';
import { Decimalish } from '@fluidity/lib-base';
import { ErrorCode } from '@ethersproject/logger';
import { FailedReceipt } from '@fluidity/lib-base';
import { Fees } from '@fluidity/lib-base';
import { FrontendStatus } from '@fluidity/lib-base';
import { LiquidationDetails } from '@fluidity/lib-base';
import { LiquityReceipt } from '@fluidity/lib-base';
...
import { PopulatedRedemption } from '@fluidity/lib-base';
import { PopulatedTransaction } from '@ethersproject/contracts';
import { Provider } from '@ethersproject/abstract-provider';
import { ReadableLiquity } from '@fluidity/lib-base';
import { RedemptionDetails } from '@fluidity/lib-base';
import { SendableLiquity } from '@fluidity/lib-base';
import { SentLiquityTransaction } from '@fluidity/lib-base';
import { Signer } from '@ethersproject/abstract-signer';
import { StabilityDeposit } from '@fluidity/lib-base';
import { StabilityDepositChangeDetails } from '@fluidity/lib-base';
import { StabilityPoolGainsWithdrawalDetails } from '@fluidity/lib-base';
import { TransactableLiquity } from '@fluidity/lib-base';
import { TransactionFailedError } from '@fluidity/lib-base';
import { TransactionReceipt } from '@ethersproject/abstract-provider';
import { TransactionResponse } from '@ethersproject/abstract-provider';
import { Trove } from '@fluidity/lib-base';
import { TroveAdjustmentDetails } from '@fluidity/lib-base';
import { TroveAdjustmentParams } from '@fluidity/lib-base';
import { TroveClosureDetails } from '@fluidity/lib-base';
import { TroveCreationDetails } from '@fluidity/lib-base';
import { TroveCreationParams } from '@fluidity/lib-base';
import { TroveListingParams } from '@fluidity/lib-base';
import { TroveWithPendingRedistribution } from '@fluidity/lib-base';
import { UserTrove } from '@fluidity/lib-base';
...
export class EthersLiquity implements ReadableEthersLiquity, TransactableLiquity {
    ...
    // (undocumented)
    repayONEU(amount: Decimalish, overrides?: EthersTransactionOverrides): Promise<TroveAdjustmentDetails>;
    readonly send: SendableEthersLiquity;
    // (undocumented)
    sendONEU(toAddress: string, amount: Decimalish, overrides?: EthersTransactionOverrides): Promise<void>;
    // (undocumented)
    sendOPL(toAddress: string, amount: Decimalish, overrides?: EthersTransactionOverrides): Promise<void>;
    // @internal (undocumented)
...
export class PopulatedEthersRedemption extends PopulatedEthersLiquityTransaction<RedemptionDetails> implements PopulatedRedemption<EthersPopulatedTransaction, EthersTransactionResponse, EthersTransactionReceipt> {
    // @internal
    constructor(rawPopulatedTransaction: EthersPopulatedTransaction, connection: EthersLiquityConnection, attemptedONEUAmount: Decimal, redeemableONEUAmount: Decimal, increaseAmountByMinimumNetDebt?: (maxRedemptionRate?: Decimalish) => Promise<PopulatedEthersRedemption>);
    // (undocumented)
